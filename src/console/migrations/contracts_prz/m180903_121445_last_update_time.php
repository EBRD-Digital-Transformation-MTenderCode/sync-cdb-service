...
class m180903_121445_last_update_time extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->insert(self::TABLE_NAME, ['id' => 'contracts-prz-changed-list', 'updated_at' => null, 'offset_time' => null]);
    }
